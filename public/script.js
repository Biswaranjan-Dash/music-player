...
async function displayAlbums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("Songs")) {
            ...
            let folder = e.href.split("/public/Songs/")[1]?.split("/")[0];
            ...
            if (folder) {
                console.log("1st");
                try {
                    let metadataFetch = await fetch(`/public/Songs/${folder}/info.json`);
                    if (!metadataFetch.ok) {
                ...
                cardContainer.innerHTML += `
                    <div class="card" data-folder="${folder}">
                        ...
                        <img src="/public/Songs/${folder}/cover.jpg" alt="playlist-img">
